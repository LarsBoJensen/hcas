...
class TrashNodeTest extends BrowserTestBase {
  ...
  public function testTrashConfirmationTextVariesAppropriately(): void {
    ...
    $this->drupalGet('node/' . $node->id() . '/delete');
    $this->assertSession()->pageTextContains('Deleting this content item will move it to the trash. You can restore it from the trash for a limited period of time (1 month) if necessary.');
  }
